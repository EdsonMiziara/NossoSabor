class NavbarComponent extends HTMLElement {
    connectedCallback() {
        ...
        this.innerHTML = `
        <nav class="navbar fixed-top navbar-dark w-100 border-bottom border-white border-opacity-25" style="background-color: rgba(117, 130, 111, 0.75); backdrop-filter: blur(10px); -webkit-backdrop-filter: blur(10px);">
            <div class="container-fluid px-3 px-md-4 d-flex justify-content-between align-items-center">
                
                <a class="navbar-brand icon-link icon-link-hover m-0"
                ...
                <button class="navbar-toggler border-0 shadow-none p-1" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbar"
